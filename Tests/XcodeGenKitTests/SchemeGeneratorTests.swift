        ...
        describe {
            ...
            $0.it("generates scheme") {
                ...
                let scheme = try Scheme(
                    ...
                    run: Scheme.Run(config: "Debug", askForAppToLaunch: true, launchAutomaticallySubstyle: "2", simulateLocation: simulateLocation, storeKitConfiguration: storeKitConfiguration, customLLDBInit: "/sample/.lldbinit", queueDebuggingEnabled: false),
                ...
                try expect(xcscheme.launchAction?.queueDebuggingEnabled) == false
